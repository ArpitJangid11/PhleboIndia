...
const Connect = ()=>{
  const data = fetch('http://localhost:5500/api/contact',{
    method:'post',
        ...
        <div className="w-4/5 my-5 mx-auto flex flex-col items-center md:flex-row ">
          <div className="border w-[70%] h-full bg-cyan-200 text-black p-10">
            ...
            <div className="mt-6 leading-7 text-center">
              ...
              ></textarea>
              <button onClick={Connect} className="block m-auto w-[60%] md:w-[50%] text-center border bg-green-700 rounded-full py-1 mt-6 text-lg font-bold tracking-wide uppercase text-white brightness-105 hover:bg-green-400">
                Send
              </button>
            </div>
          </div>
