    ...
    return (
      ...
      items-center min-h-screen">
        <div className="h-full absolute top-0 left-0 z-0">
          <Image src="/cover-bg.jpg" alt="" width={500} height={500} className="w-full h-full object-cover opacity-50"/>
        </div>
        ...
        <div className="lg:w-3/4 xl:w-2/4 relative z-10 h-100 lg:mt-16">
          <div>
            <h1 className="text-white text-4xl md:text-5xl xl:text-6xl font-bold leading-tight">A better life starts with a
              beautiful
              smile.</h1>
            <p className="text-blue-100 text-xl md:text-2xl leading-snug mt-4">Welcome to the Hospital,where trust and comfort are priorities.</p>
            <a href="#" className="px-8 py-4 bg-green-500 text-white rounded inline-block mt-8 font-semibold">Book
              Appointment</a>
          </div>
        </div>
      </section>
    ...
    <section className="relative px-4 py-16 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 lg:py-32">
      <div className="flex flex-col lg:flex-row lg:-mx-8">
        <div className="w-full lg:w-1/2 lg:px-8">
          <h2 className="text-3xl leading-tight font-bold mt-4">Welcome to the Hospital</h2>
          <p className="text-lg mt-4 font-semibold">Excellence in Health care in the Heart of NY</p>
