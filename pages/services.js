...
const Services = () => {
  ...
  const [collectionToTime, setCollectionToTime] = useState("");
            ...
            <div className="px-4 py-5 bg-white sm:p-6">
              <div className="grid grid-cols-6 gap-6">
                <div className="col-span-6 sm:col-span-3">
                  ...
                  >
                    <option className="text-gray-500">Select affiliate</option>
                ...
                <div className="col-span-6 sm:col-span-3">
                  ...
                  <select
                    value={collectionToTime}
                    onChange={(e) => setCollectionToTime(e.target.value)}
                    id="country"
                    name="country"
                    autoComplete="country"
                    className="mt-1 block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm bg-gray-200"
                ...
                <div className="col-span-6 sm:col-span-2">
                  ...
                  <input
                    ...
                    id="first_name"
                    autoComplete="given-name"
                    className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-65% py-2 px-3 shadow-sm sm:text-sm border-gray-700 rounded-md bg-gray-200 "
                  />
                </div>
                ...
                <div className="col-span-6 sm:col-span-1">
                  ...
                  <input
                    ...
                    id="email_address"
                    autoComplete="email"
                    className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-65% py-2 px-3 shadow-sm sm:text-sm border-gray-300 rounded-md bg-gray-200"
                  />
                </div>
                ...
                <div className="col-span-6 sm:col-span-2">
                  ...
                  <input
                    ...
                    className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-50% py-2 px-3 shadow-sm sm:text-sm border-gray-300 rounded-md bg-gray-200"
                  />
                </div>
